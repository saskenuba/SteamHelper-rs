...
fn main() {
    ...
    let file_steam_msg: &'static str = include_str!("../../assets/SteamKit/Resources/SteamLanguage/steammsg.steamd");

    let file_eresult: &'static str = include_str!("../../assets/SteamKit/Resources/SteamLanguage/eresult.steamd");

    let file_emsg: &'static str = include_str!("../../assets/SteamKit/Resources/SteamLanguage/emsg.steamd");

    let file_steam_enums: &'static str = include_str!("../../assets/SteamKit/Resources/SteamLanguage/enums.steamd");
