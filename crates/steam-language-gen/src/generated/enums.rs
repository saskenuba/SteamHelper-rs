...
#[derive(FromPrimitive, ToPrimitive, Debug, PartialEq, Eq, Serialize, Deserialize)]
#[repr(i32)]
pub enum EUniverse {
	Invalid = 0,
	Public = 1,
...
#[derive(FromPrimitive, ToPrimitive, Debug, PartialEq, Eq, Serialize_repr, Deserialize_repr)]
#[repr(i32)]
pub enum EResult {
	Invalid = 0,
	OK = 1,
