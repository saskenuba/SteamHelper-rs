...
pub struct CMsgSteamDatagramRelayAuthTicket {
    ...
    pub gameserver_address: ::std::option::Option<::bytes::Bytes>,
    ...
    pub legacy_authorized_client_identity_binary: ::std::option::Option<::bytes::Bytes>,
    // @@protoc_insertion_point(field:CMsgSteamDatagramRelayAuthTicket.legacy_gameserver_identity_binary)
    pub legacy_gameserver_identity_binary: ::std::option::Option<::bytes::Bytes>,
    // special fields
...
impl<'a> ::std::default::Default for &'a CMsgSteamDatagramRelayAuthTicket {
    fn default() -> &'a CMsgSteamDatagramRelayAuthTicket {
        <CMsgSteamDatagramRelayAuthTicket as crate::Message>::default_instance()
    }
}
...
impl CMsgSteamDatagramRelayAuthTicket {
    ...
    // Param is passed by value, moved
    pub fn set_gameserver_address(&mut self, v: ::bytes::Bytes) {
        self.gameserver_address = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_gameserver_address(&mut self) -> &mut ::bytes::Bytes {
        if self.gameserver_address.is_none() {
            self.gameserver_address = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.gameserver_address.as_mut().unwrap()
    }

    // Take field
    pub fn take_gameserver_address(&mut self) -> ::bytes::Bytes {
        self.gameserver_address.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    pub fn extra_fields(&self) -> &[cmsg_steam_datagram_relay_auth_ticket::ExtraField] {
        &self.extra_fields
    }
    ...
    // Param is passed by value, moved
    pub fn set_extra_fields(&mut self, v: ::std::vec::Vec<cmsg_steam_datagram_relay_auth_ticket::ExtraField>) {
        self.extra_fields = v;
    }

    // Mutable pointer to the field.
    pub fn mut_extra_fields(&mut self) -> &mut ::std::vec::Vec<cmsg_steam_datagram_relay_auth_ticket::ExtraField> {
        &mut self.extra_fields
    }

    // Take field
    pub fn take_extra_fields(&mut self) -> ::std::vec::Vec<cmsg_steam_datagram_relay_auth_ticket::ExtraField> {
        ::std::mem::replace(&mut self.extra_fields, ::std::vec::Vec::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_legacy_authorized_client_identity_binary(&mut self, v: ::bytes::Bytes) {
        self.legacy_authorized_client_identity_binary = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_legacy_authorized_client_identity_binary(&mut self) -> &mut ::bytes::Bytes {
        if self.legacy_authorized_client_identity_binary.is_none() {
            self.legacy_authorized_client_identity_binary = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.legacy_authorized_client_identity_binary.as_mut().unwrap()
    }

    // Take field
    pub fn take_legacy_authorized_client_identity_binary(&mut self) -> ::bytes::Bytes {
        self.legacy_authorized_client_identity_binary.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_legacy_gameserver_identity_binary(&mut self, v: ::bytes::Bytes) {
        self.legacy_gameserver_identity_binary = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_legacy_gameserver_identity_binary(&mut self) -> &mut ::bytes::Bytes {
        if self.legacy_gameserver_identity_binary.is_none() {
            self.legacy_gameserver_identity_binary = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.legacy_gameserver_identity_binary.as_mut().unwrap()
    }

    // Take field
    pub fn take_legacy_gameserver_identity_binary(&mut self) -> ::bytes::Bytes {
        self.legacy_gameserver_identity_binary.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    fn generated_message_descriptor_data() -> crate::reflect::GeneratedMessageDescriptorData {
        ...
        crate::reflect::GeneratedMessageDescriptorData::new_2::<CMsgSteamDatagramRelayAuthTicket>(
...
impl crate::Message for CMsgSteamDatagramRelayAuthTicket {
    ...
    fn merge_from(&mut self, is: &mut crate::CodedInputStream<'_>) -> crate::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                90 => {
                    self.gameserver_address = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                56 => {
                ...
                98 => {
                    self.legacy_authorized_client_identity_binary = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                106 => {
                    self.legacy_gameserver_identity_binary = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.legacy_gameserver_identity_binary.as_ref() {
            my_size += crate::rt::bytes_size(13, &v);
        }
...
impl crate::MessageFull for CMsgSteamDatagramRelayAuthTicket {
...
impl crate::reflect::ProtobufValue for CMsgSteamDatagramRelayAuthTicket {
...
pub mod cmsg_steam_datagram_relay_auth_ticket {
    ...
    impl<'a> ::std::default::Default for &'a ExtraField {
        fn default() -> &'a ExtraField {
            <ExtraField as crate::Message>::default_instance()
        }
    }
    ...
    impl ExtraField {
        ...
        pub(in super) fn generated_message_descriptor_data() -> crate::reflect::GeneratedMessageDescriptorData {
            ...
            crate::reflect::GeneratedMessageDescriptorData::new_2::<ExtraField>(
    ...
    impl crate::Message for ExtraField {
        ...
        fn compute_size(&self) -> u64 {
            ...
            if let Some(v) = self.int64_value {
                my_size += crate::rt::sint64_size(3, v);
            }
    ...
    impl crate::MessageFull for ExtraField {
        fn descriptor() -> crate::reflect::MessageDescriptor {
            static descriptor: crate::rt::Lazy<crate::reflect::MessageDescriptor> = crate::rt::Lazy::new();
    ...
    impl crate::reflect::ProtobufValue for ExtraField {
        type RuntimeType = crate::reflect::rt::RuntimeTypeMessage<Self>;
    }
}
...
impl<'a> ::std::default::Default for &'a CMsgSteamDatagramSignedRelayAuthTicket {
    fn default() -> &'a CMsgSteamDatagramSignedRelayAuthTicket {
        <CMsgSteamDatagramSignedRelayAuthTicket as crate::Message>::default_instance()
    }
}
...
impl CMsgSteamDatagramSignedRelayAuthTicket {
    ...
    pub fn certs(&self) -> &[super::steamnetworkingsockets_messages_certs::CMsgSteamDatagramCertificateSigned] {
        &self.certs
    }
    ...
    // Param is passed by value, moved
    pub fn set_certs(&mut self, v: ::std::vec::Vec<super::steamnetworkingsockets_messages_certs::CMsgSteamDatagramCertificateSigned>) {
        self.certs = v;
    }

    // Mutable pointer to the field.
    pub fn mut_certs(&mut self) -> &mut ::std::vec::Vec<super::steamnetworkingsockets_messages_certs::CMsgSteamDatagramCertificateSigned> {
        &mut self.certs
    }

    // Take field
    pub fn take_certs(&mut self) -> ::std::vec::Vec<super::steamnetworkingsockets_messages_certs::CMsgSteamDatagramCertificateSigned> {
        ::std::mem::replace(&mut self.certs, ::std::vec::Vec::new())
    }
    ...
    fn generated_message_descriptor_data() -> crate::reflect::GeneratedMessageDescriptorData {
        ...
        crate::reflect::GeneratedMessageDescriptorData::new_2::<CMsgSteamDatagramSignedRelayAuthTicket>(
...
impl crate::Message for CMsgSteamDatagramSignedRelayAuthTicket {
...
impl crate::MessageFull for CMsgSteamDatagramSignedRelayAuthTicket {
    fn descriptor() -> crate::reflect::MessageDescriptor {
        static descriptor: crate::rt::Lazy<crate::reflect::MessageDescriptor> = crate::rt::Lazy::new();
...
impl crate::reflect::ProtobufValue for CMsgSteamDatagramSignedRelayAuthTicket {
    type RuntimeType = crate::reflect::rt::RuntimeTypeMessage<Self>;
}
...
pub struct CMsgSteamDatagramCachedCredentialsForApp {
    ...
    pub private_key: ::std::option::Option<::bytes::Bytes>,
    ...
    pub relay_tickets: ::std::vec::Vec<::bytes::Bytes>,
    // special fields
...
impl<'a> ::std::default::Default for &'a CMsgSteamDatagramCachedCredentialsForApp {
    fn default() -> &'a CMsgSteamDatagramCachedCredentialsForApp {
        <CMsgSteamDatagramCachedCredentialsForApp as crate::Message>::default_instance()
    }
}
...
impl CMsgSteamDatagramCachedCredentialsForApp {
    ...
    // Param is passed by value, moved
    pub fn set_private_key(&mut self, v: ::bytes::Bytes) {
        self.private_key = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_private_key(&mut self) -> &mut ::bytes::Bytes {
        if self.private_key.is_none() {
            self.private_key = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.private_key.as_mut().unwrap()
    }

    // Take field
    pub fn take_private_key(&mut self) -> ::bytes::Bytes {
        self.private_key.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    pub fn relay_tickets(&self) -> &[::bytes::Bytes] {
        &self.relay_tickets
    }
    ...
    // Param is passed by value, moved
    pub fn set_relay_tickets(&mut self, v: ::std::vec::Vec<::bytes::Bytes>) {
        self.relay_tickets = v;
    }

    // Mutable pointer to the field.
    pub fn mut_relay_tickets(&mut self) -> &mut ::std::vec::Vec<::bytes::Bytes> {
        &mut self.relay_tickets
    }

    // Take field
    pub fn take_relay_tickets(&mut self) -> ::std::vec::Vec<::bytes::Bytes> {
        ::std::mem::replace(&mut self.relay_tickets, ::std::vec::Vec::new())
    }
    ...
    fn generated_message_descriptor_data() -> crate::reflect::GeneratedMessageDescriptorData {
        ...
        crate::reflect::GeneratedMessageDescriptorData::new_2::<CMsgSteamDatagramCachedCredentialsForApp>(
...
impl crate::Message for CMsgSteamDatagramCachedCredentialsForApp {
    ...
    fn merge_from(&mut self, is: &mut crate::CodedInputStream<'_>) -> crate::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.private_key = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                18 => {
                    self.cert = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                26 => {
                    self.relay_tickets.push(is.read_tokio_bytes()?);
                },
                tag => {
                    crate::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        for value in &self.relay_tickets {
            my_size += crate::rt::bytes_size(3, &value);
        };
        my_size += crate::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
...
impl crate::MessageFull for CMsgSteamDatagramCachedCredentialsForApp {
    fn descriptor() -> crate::reflect::MessageDescriptor {
        static descriptor: crate::rt::Lazy<crate::reflect::MessageDescriptor> = crate::rt::Lazy::new();
...
impl crate::reflect::ProtobufValue for CMsgSteamDatagramCachedCredentialsForApp {
    type RuntimeType = crate::reflect::rt::RuntimeTypeMessage<Self>;
}
...
impl<'a> ::std::default::Default for &'a CMsgSteamDatagramGameCoordinatorServerLogin {
    fn default() -> &'a CMsgSteamDatagramGameCoordinatorServerLogin {
        <CMsgSteamDatagramGameCoordinatorServerLogin as crate::Message>::default_instance()
    }
}
...
impl CMsgSteamDatagramGameCoordinatorServerLogin {
    ...
    // Param is passed by value, moved
    pub fn set_routing(&mut self, v: ::bytes::Bytes) {
        self.routing = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_routing(&mut self) -> &mut ::bytes::Bytes {
        if self.routing.is_none() {
            self.routing = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.routing.as_mut().unwrap()
    }

    // Take field
    pub fn take_routing(&mut self) -> ::bytes::Bytes {
        self.routing.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_appdata(&mut self, v: ::bytes::Bytes) {
        self.appdata = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_appdata(&mut self) -> &mut ::bytes::Bytes {
        if self.appdata.is_none() {
            self.appdata = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.appdata.as_mut().unwrap()
    }

    // Take field
    pub fn take_appdata(&mut self) -> ::bytes::Bytes {
        self.appdata.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_legacy_identity_binary(&mut self, v: ::bytes::Bytes) {
        self.legacy_identity_binary = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_legacy_identity_binary(&mut self) -> &mut ::bytes::Bytes {
        if self.legacy_identity_binary.is_none() {
            self.legacy_identity_binary = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.legacy_identity_binary.as_mut().unwrap()
    }

    // Take field
    pub fn take_legacy_identity_binary(&mut self) -> ::bytes::Bytes {
        self.legacy_identity_binary.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    fn generated_message_descriptor_data() -> crate::reflect::GeneratedMessageDescriptorData {
        ...
        crate::reflect::GeneratedMessageDescriptorData::new_2::<CMsgSteamDatagramGameCoordinatorServerLogin>(
...
impl crate::Message for CMsgSteamDatagramGameCoordinatorServerLogin {
    ...
    fn merge_from(&mut self, is: &mut crate::CodedInputStream<'_>) -> crate::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                26 => {
                    self.routing = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                34 => {
                    self.appdata = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                42 => {
                    self.legacy_identity_binary = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                50 => {
...
impl crate::MessageFull for CMsgSteamDatagramGameCoordinatorServerLogin {
    fn descriptor() -> crate::reflect::MessageDescriptor {
        static descriptor: crate::rt::Lazy<crate::reflect::MessageDescriptor> = crate::rt::Lazy::new();
...
impl crate::reflect::ProtobufValue for CMsgSteamDatagramGameCoordinatorServerLogin {
    type RuntimeType = crate::reflect::rt::RuntimeTypeMessage<Self>;
}
...
pub struct CMsgSteamDatagramSignedGameCoordinatorServerLogin {
    ...
    pub login: ::std::option::Option<::bytes::Bytes>,
...
impl<'a> ::std::default::Default for &'a CMsgSteamDatagramSignedGameCoordinatorServerLogin {
    fn default() -> &'a CMsgSteamDatagramSignedGameCoordinatorServerLogin {
        <CMsgSteamDatagramSignedGameCoordinatorServerLogin as crate::Message>::default_instance()
    }
}
...
impl CMsgSteamDatagramSignedGameCoordinatorServerLogin {
    ...
    // Param is passed by value, moved
    pub fn set_login(&mut self, v: ::bytes::Bytes) {
        self.login = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_login(&mut self) -> &mut ::bytes::Bytes {
        if self.login.is_none() {
            self.login = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.login.as_mut().unwrap()
    }

    // Take field
    pub fn take_login(&mut self) -> ::bytes::Bytes {
        self.login.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    fn generated_message_descriptor_data() -> crate::reflect::GeneratedMessageDescriptorData {
        ...
        crate::reflect::GeneratedMessageDescriptorData::new_2::<CMsgSteamDatagramSignedGameCoordinatorServerLogin>(
...
impl crate::Message for CMsgSteamDatagramSignedGameCoordinatorServerLogin {
    ...
    fn merge_from(&mut self, is: &mut crate::CodedInputStream<'_>) -> crate::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    self.login = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                26 => {
                    self.signature = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
...
impl crate::MessageFull for CMsgSteamDatagramSignedGameCoordinatorServerLogin {
    fn descriptor() -> crate::reflect::MessageDescriptor {
        static descriptor: crate::rt::Lazy<crate::reflect::MessageDescriptor> = crate::rt::Lazy::new();
...
impl crate::reflect::ProtobufValue for CMsgSteamDatagramSignedGameCoordinatorServerLogin {
    type RuntimeType = crate::reflect::rt::RuntimeTypeMessage<Self>;
}
...
pub struct CMsgSteamDatagramHostedServerAddressPlaintext {
    ...
    pub ipv6: ::std::option::Option<::bytes::Bytes>,
...
impl<'a> ::std::default::Default for &'a CMsgSteamDatagramHostedServerAddressPlaintext {
    fn default() -> &'a CMsgSteamDatagramHostedServerAddressPlaintext {
        <CMsgSteamDatagramHostedServerAddressPlaintext as crate::Message>::default_instance()
    }
}
...
impl CMsgSteamDatagramHostedServerAddressPlaintext {
    ...
    // Param is passed by value, moved
    pub fn set_ipv6(&mut self, v: ::bytes::Bytes) {
        self.ipv6 = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_ipv6(&mut self) -> &mut ::bytes::Bytes {
        if self.ipv6.is_none() {
            self.ipv6 = ::std::option::Option::Some(::bytes::Bytes::new());
        }
        self.ipv6.as_mut().unwrap()
    }

    // Take field
    pub fn take_ipv6(&mut self) -> ::bytes::Bytes {
        self.ipv6.take().unwrap_or_else(|| ::bytes::Bytes::new())
    }
    ...
    fn generated_message_descriptor_data() -> crate::reflect::GeneratedMessageDescriptorData {
        ...
        crate::reflect::GeneratedMessageDescriptorData::new_2::<CMsgSteamDatagramHostedServerAddressPlaintext>(
...
impl crate::Message for CMsgSteamDatagramHostedServerAddressPlaintext {
    ...
    fn merge_from(&mut self, is: &mut crate::CodedInputStream<'_>) -> crate::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    self.ipv6 = ::std::option::Option::Some(is.read_tokio_bytes()?);
                },
                24 => {
...
impl crate::MessageFull for CMsgSteamDatagramHostedServerAddressPlaintext {
    fn descriptor() -> crate::reflect::MessageDescriptor {
        static descriptor: crate::rt::Lazy<crate::reflect::MessageDescriptor> = crate::rt::Lazy::new();
...
impl crate::reflect::ProtobufValue for CMsgSteamDatagramHostedServerAddressPlaintext {
    type RuntimeType = crate::reflect::rt::RuntimeTypeMessage<Self>;
}
