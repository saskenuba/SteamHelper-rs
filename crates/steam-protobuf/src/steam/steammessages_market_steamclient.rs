...
impl ::protobuf::Message for CEconMarket_IsMarketplaceAllowed_Request {
    ...
    fn default_instance() -> &'static CEconMarket_IsMarketplaceAllowed_Request {
        static mut instance: ::protobuf::lazy::Lazy<CEconMarket_IsMarketplaceAllowed_Request> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CEconMarket_IsMarketplaceAllowed_Request,
        };
        unsafe {
...
impl ::protobuf::Message for CEconMarket_IsMarketplaceAllowed_Response {
    ...
    fn default_instance() -> &'static CEconMarket_IsMarketplaceAllowed_Response {
        static mut instance: ::protobuf::lazy::Lazy<CEconMarket_IsMarketplaceAllowed_Response> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CEconMarket_IsMarketplaceAllowed_Response,
        };
        unsafe {
