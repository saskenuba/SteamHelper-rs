...
pub struct CMsgSteamDatagramCachedCredentialsForApp {
    ...
    relay_tickets: ::protobuf::RepeatedField<::std::vec::Vec<u8>>,
    // special fields
    #[cfg_attr(feature = "with-serde", serde(skip))]
    pub unknown_fields: ::protobuf::UnknownFields,
    #[cfg_attr(feature = "with-serde", serde(skip))]
...
impl ::protobuf::Message for CMsgSteamDatagramCachedCredentialsForApp {
    ...
    fn default_instance() -> &'static CMsgSteamDatagramCachedCredentialsForApp {
        static mut instance: ::protobuf::lazy::Lazy<CMsgSteamDatagramCachedCredentialsForApp> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CMsgSteamDatagramCachedCredentialsForApp,
        };
        unsafe {
...
impl ::protobuf::Message for CMsgSteamDatagramGameCoordinatorServerLogin {
    ...
    fn default_instance() -> &'static CMsgSteamDatagramGameCoordinatorServerLogin {
        static mut instance: ::protobuf::lazy::Lazy<CMsgSteamDatagramGameCoordinatorServerLogin> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CMsgSteamDatagramGameCoordinatorServerLogin,
        };
        unsafe {
...
impl ::protobuf::Message for CMsgSteamDatagramSignedGameCoordinatorServerLogin {
    ...
    fn default_instance() -> &'static CMsgSteamDatagramSignedGameCoordinatorServerLogin {
        static mut instance: ::protobuf::lazy::Lazy<CMsgSteamDatagramSignedGameCoordinatorServerLogin> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CMsgSteamDatagramSignedGameCoordinatorServerLogin,
        };
        unsafe {
...
impl ::protobuf::Message for CMsgSteamDatagramHostedServerAddressPlaintext {
    ...
    fn default_instance() -> &'static CMsgSteamDatagramHostedServerAddressPlaintext {
        static mut instance: ::protobuf::lazy::Lazy<CMsgSteamDatagramHostedServerAddressPlaintext> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CMsgSteamDatagramHostedServerAddressPlaintext,
        };
        unsafe {
