...
impl ::protobuf::Message for CKeyEscrow_Request {
    ...
    fn default_instance() -> &'static CKeyEscrow_Request {
        static mut instance: ::protobuf::lazy::Lazy<CKeyEscrow_Request> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CKeyEscrow_Request,
        };
        unsafe {
...
impl ::protobuf::Message for CKeyEscrow_Ticket {
    ...
    fn default_instance() -> &'static CKeyEscrow_Ticket {
        static mut instance: ::protobuf::lazy::Lazy<CKeyEscrow_Ticket> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CKeyEscrow_Ticket,
        };
        unsafe {
...
pub struct CKeyEscrow_Response {
    // message fields
    ticket: ::protobuf::SingularPtrField<CKeyEscrow_Ticket>,
    // special fields
    #[cfg_attr(feature = "with-serde", serde(skip))]
    pub unknown_fields: ::protobuf::UnknownFields,
    #[cfg_attr(feature = "with-serde", serde(skip))]
...
impl CKeyEscrow_Response {
    ...
    pub fn get_ticket(&self) -> &CKeyEscrow_Ticket {
        self.ticket.as_ref().unwrap_or_else(|| CKeyEscrow_Ticket::default_instance())
    }
...
impl ::protobuf::Message for CKeyEscrow_Response {
    ...
    fn default_instance() -> &'static CKeyEscrow_Response {
        static mut instance: ::protobuf::lazy::Lazy<CKeyEscrow_Response> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CKeyEscrow_Response,
        };
        unsafe {
...
impl ::protobuf::ProtobufEnum for EKeyEscrowUsage {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ::protobuf::reflect::EnumDescriptor::new("EKeyEscrowUsage", file_descriptor_proto())
            })
        }
    }
}
