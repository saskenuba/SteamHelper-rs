...
impl ::protobuf::Message for CMsgSteamNetworkingIdentityLegacyBinary {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::rt::make_option_get_copy_accessor::<_, ::protobuf::reflect::types::ProtobufTypeFixed64, _>(
                ...
                CMsgSteamNetworkingIdentityLegacyBinary::get_steam_id,
            ));
            fields.push(::protobuf::reflect::rt::make_option_get_ref_accessor::<_, ::protobuf::reflect::types::ProtobufTypeString, _>(
                ...
                CMsgSteamNetworkingIdentityLegacyBinary::get_xbox_pairwise_id,
            ));
            fields.push(::protobuf::reflect::rt::make_option_get_ref_accessor::<_, ::protobuf::reflect::types::ProtobufTypeBytes, _>(
                ...
                CMsgSteamNetworkingIdentityLegacyBinary::get_generic_bytes,
            ));
            fields.push(::protobuf::reflect::rt::make_option_get_ref_accessor::<_, ::protobuf::reflect::types::ProtobufTypeString, _>(
                "generic_string",
                ...
                CMsgSteamNetworkingIdentityLegacyBinary::get_generic_string,
            ));
            fields.push(::protobuf::reflect::rt::make_option_get_ref_accessor::<_, ::protobuf::reflect::types::ProtobufTypeBytes, _>(
                "ipv6_and_port",
                ...
                CMsgSteamNetworkingIdentityLegacyBinary::get_ipv6_and_port,
            ));
            ::protobuf::reflect::MessageDescriptor::new::<CMsgSteamNetworkingIdentityLegacyBinary>(
    ...
    fn default_instance() -> &'static CMsgSteamNetworkingIdentityLegacyBinary {
        static instance: ::protobuf::rt::Lazy<CMsgSteamNetworkingIdentityLegacyBinary> = ::protobuf::rt::Lazy::INIT;
...
pub struct CMsgSteamDatagramCertificate {
    // message fields
    key_type: ::std::option::Option<::protobuf::ProtobufEnumOrUnknown<cmsg_steam_datagram_certificate::EKeyType>>,
...
impl CMsgSteamDatagramCertificate {
    ...
    pub fn get_key_type(&self) -> cmsg_steam_datagram_certificate::EKeyType {
        match self.key_type {
...
impl ::protobuf::Message for CMsgSteamDatagramCertificate {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                11 => {
                    ::protobuf::rt::read_singular_message_into::<CMsgSteamNetworkingIdentityLegacyBinary, _>(wire_type, is, &mut self.legacy_identity_binary)?;
                },
                12 => {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::rt::make_option_enum_accessor::<_, cmsg_steam_datagram_certificate::EKeyType>(
                "key_type",
                |m: &CMsgSteamDatagramCertificate| { &m.key_type },
                |m: &mut CMsgSteamDatagramCertificate| { &mut m.key_type },
                cmsg_steam_datagram_certificate::EKeyType::INVALID,
            ));
            fields.push(::protobuf::reflect::rt::make_option_get_ref_accessor::<_, ::protobuf::reflect::types::ProtobufTypeBytes, _>(
                "key_data",
                |m: &CMsgSteamDatagramCertificate| { &m.key_data },
                |m: &mut CMsgSteamDatagramCertificate| { &mut m.key_data },
                CMsgSteamDatagramCertificate::get_key_data,
            ));
            fields.push(::protobuf::reflect::rt::make_option_get_copy_accessor::<_, ::protobuf::reflect::types::ProtobufTypeFixed64, _>(
                "legacy_steam_id",
                |m: &CMsgSteamDatagramCertificate| { &m.legacy_steam_id },
                |m: &mut CMsgSteamDatagramCertificate| { &mut m.legacy_steam_id },
                CMsgSteamDatagramCertificate::get_legacy_steam_id,
            ));
            fields.push(::protobuf::reflect::rt::make_option_accessor::<_, ::protobuf::reflect::types::ProtobufTypeMessage<CMsgSteamNetworkingIdentityLegacyBinary>, _>(
            ...
            fields.push(::protobuf::reflect::rt::make_option_get_ref_accessor::<_, ::protobuf::reflect::types::ProtobufTypeString, _>(
                ...
                CMsgSteamDatagramCertificate::get_identity_string,
            ));
    ...
    fn default_instance() -> &'static CMsgSteamDatagramCertificate {
        static instance: ::protobuf::rt::Lazy<CMsgSteamDatagramCertificate> = ::protobuf::rt::Lazy::INIT;
...
pub mod cmsg_steam_datagram_certificate {
    ...
    impl ::protobuf::ProtobufEnum for EKeyType {
        ...
        fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
            ...
            descriptor.get(|| {
                ::protobuf::reflect::EnumDescriptor::new::<EKeyType>("CMsgSteamDatagramCertificate.EKeyType", super::file_descriptor_proto())
            })
        }
    }
...
impl ::protobuf::Message for CMsgSteamDatagramCertificateSigned {
    ...
    fn default_instance() -> &'static CMsgSteamDatagramCertificateSigned {
        static instance: ::protobuf::rt::Lazy<CMsgSteamDatagramCertificateSigned> = ::protobuf::rt::Lazy::INIT;
...
impl ::protobuf::Message for CMsgSteamDatagramCertificateRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_message_into::<CMsgSteamDatagramCertificate, _>(wire_type, is, &mut self.cert)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::rt::make_option_accessor::<_, ::protobuf::reflect::types::ProtobufTypeMessage<CMsgSteamDatagramCertificate>, _>(
                "cert",
                |m: &CMsgSteamDatagramCertificateRequest| { &m.cert },
                |m: &mut CMsgSteamDatagramCertificateRequest| { &mut m.cert },
            ));
            ::protobuf::reflect::MessageDescriptor::new::<CMsgSteamDatagramCertificateRequest>(
    ...
    fn default_instance() -> &'static CMsgSteamDatagramCertificateRequest {
        static instance: ::protobuf::rt::Lazy<CMsgSteamDatagramCertificateRequest> = ::protobuf::rt::Lazy::INIT;
