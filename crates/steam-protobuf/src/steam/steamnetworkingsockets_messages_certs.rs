...
impl ::protobuf::Message for CMsgSteamNetworkingIdentityLegacyBinary {
    ...
    fn default_instance() -> &'static CMsgSteamNetworkingIdentityLegacyBinary {
        static mut instance: ::protobuf::lazy::Lazy<CMsgSteamNetworkingIdentityLegacyBinary> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CMsgSteamNetworkingIdentityLegacyBinary,
        };
        unsafe {
...
pub struct CMsgSteamDatagramCertificate {
    ...
    legacy_identity_binary: ::protobuf::SingularPtrField<CMsgSteamNetworkingIdentityLegacyBinary>,
    identity_string: ::protobuf::SingularField<::std::string::String>,
    gameserver_datacenter_ids: ::std::vec::Vec<u32>,
...
impl CMsgSteamDatagramCertificate {
    ...
    pub fn get_legacy_identity_binary(&self) -> &CMsgSteamNetworkingIdentityLegacyBinary {
        self.legacy_identity_binary.as_ref().unwrap_or_else(|| CMsgSteamNetworkingIdentityLegacyBinary::default_instance())
    }
...
pub struct CMsgSteamDatagramCertificateRequest {
    // message fields
    cert: ::protobuf::SingularPtrField<CMsgSteamDatagramCertificate>,
    // special fields
    #[cfg_attr(feature = "with-serde", serde(skip))]
    pub unknown_fields: ::protobuf::UnknownFields,
    #[cfg_attr(feature = "with-serde", serde(skip))]
...
impl CMsgSteamDatagramCertificateRequest {
    ...
    pub fn get_cert(&self) -> &CMsgSteamDatagramCertificate {
        self.cert.as_ref().unwrap_or_else(|| CMsgSteamDatagramCertificate::default_instance())
    }
    pub fn clear_cert(&mut self) {
        self.cert.clear();
    }
...
impl ::protobuf::Message for CMsgSteamDatagramCertificateRequest {
    ...
    fn default_instance() -> &'static CMsgSteamDatagramCertificateRequest {
        static mut instance: ::protobuf::lazy::Lazy<CMsgSteamDatagramCertificateRequest> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CMsgSteamDatagramCertificateRequest,
        };
        unsafe {
